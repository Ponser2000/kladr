...
public class DBaseUtils {
  ...
  public static List<StreetGnivc> readStreetDbf(String path, String charsetName)
      throws IOException {
  ...
  public static List<AltnamesGnivc> readAltnamesDbf(String path, String charsetName)
      throws IOException {
